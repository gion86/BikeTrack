...
public class TrackRecordingServiceConnection {
    ...
    private final ServiceConnection serviceConnection = new ServiceConnection() {
        ...
        public void onServiceConnected(ComponentName className, IBinder service) {
            ...
            TrackRecordingService.LocalBinder binder = (TrackRecordingService.LocalBinder) service;
            setTrackRecordingService(binder.getService());
        }
   ...
   /* public ITrackRecordingService getServiceIfBound() {
     ...
     */
    private static boolean isRecordingServiceRunning(Context context) {
