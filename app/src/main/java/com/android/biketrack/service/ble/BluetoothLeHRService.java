...
package com.android.biketrack.service.ble;
...
public class BluetoothLeHRService extends Service {
    ...
    public final static UUID UUID_HEART_RATE_MEASUREMENT =
            UUID.fromString(HRGattAttributes.HEART_RATE_MEASUREMENT);
    private final static String TAG = BluetoothLeHRService.class.getSimpleName();
    ...
    public class MyGattCallback extends BluetoothGattCallback implements Handler.Callback {
        ...
        public static final int MSG_SERVICES_DISCOVERED = 20;
        public static final int MSG_CHARACTERISTIC_READ = 30;
        public static final int MSG_CHARACTERISTIC_CHANGED = 40;
        ...
        public void onCharacteristicRead(BluetoothGatt gatt,
            ...
            if (status == BluetoothGatt.GATT_SUCCESS) {
                bleHandler.obtainMessage(MSG_CHARACTERISTIC_READ, characteristic).sendToTarget();
            }
        }
        ...
        public void onCharacteristicChanged(BluetoothGatt gatt,
                                            BluetoothGattCharacteristic characteristic) {
            bleHandler.obtainMessage(MSG_CHARACTERISTIC_CHANGED, characteristic).sendToTarget();
        }
    ...
    private final BluetoothGattCallback mGattCallback = new MyGattCallback();
    ...
    public void setCharacteristicNotification(BluetoothGattCharacteristic characteristic,
        ...
        if (UUID_HEART_RATE_MEASUREMENT.equals(characteristic.getUuid())) {
            BluetoothGattDescriptor descriptor = characteristic.getDescriptor(
                    UUID.fromString(HRGattAttributes.CLIENT_CHARACTERISTIC_CONFIG));
    ...
    public class LocalBinder extends Binder {
        public BluetoothLeHRService getService() {
