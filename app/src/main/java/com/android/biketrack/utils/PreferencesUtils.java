...
public class PreferencesUtils {
    ...
    /**
     * Gets the SharePreferences object
     *
     * @param context the context
     */
    public static SharedPreferences getSP(Context context) {
        return context.getSharedPreferences(Constants.SETTINGS_FILE_NAME, Context.MODE_PRIVATE);
    }
    ...
    public static boolean getBoolean(Context context, int keyId, boolean defaultValue) {
        SharedPreferences sharedPreferences = context.getSharedPreferences(
                Constants.SETTINGS_FILE_NAME, Context.MODE_PRIVATE);
